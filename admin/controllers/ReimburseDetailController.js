...
define(['angular', 'app', 'createController', 'configs'], function (angular, app, createController,configs) {
    ...
    return app.controller("ReimburseDetailController", createController(function ($scope, $http, $routeParams) {
         ...
         * get order spec api.
         */
        var api = configs.api.reimburse + "/search/spec/1/10/?reimburse=1&serial=" + $scope.orderSpec;
        var request = {
            method: 'GET',
            url: api,
        ...
        $http(request).success(function(data, status, headers, config) {
        	...
        	$scope.displayPayType($scope.row.reimburse_payment_type);
