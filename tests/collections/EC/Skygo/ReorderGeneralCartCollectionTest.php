...
require_once( FRAMEWORK_PATH . 'collections/EC/Skygo/ReorderGeneralCartCollection.php' );

/**
 * Class ReorderGeneralCartCollectionTest
 */
class ReorderGeneralCartCollectionTest extends DbHero_TestCase {
    ...
    private function getTypicalCase() {
        return json_decode('{
            ...
            "original":{
                ...
                "product_total_price":"48700",
                "final_total_price":"48700",
                "other_cost":"0",
                "cost_type":"normal",
                "fare":"0",
                "fare_type":"宅配",
                ...
                "delivery_datetime":"2015-11-15 20:14:08",
...
//    }
    ...
    public function testGetProductPrice($describe, $params, $expected) {
        echo "$describe \n\r ";
        $cart = new ReorderGeneralCartCollection($params);
