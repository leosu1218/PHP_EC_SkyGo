...
define(['angular', 'ngCookiesHelper', 'ngCartService'], function (angular, ngCookiesHelper, ngCartService) {
	...
	var app = angular.module('app', ['HashBangURLs', 'ui.bootstrap', 'ngSanitize', 'ngAnimate', 'ngCookies'], function ($routeProvider, $locationProvider, $httpProvider) {

	});

    app.service("$cookiesHelper", ngCookiesHelper);
    app.service("$cart", ngCartService);
