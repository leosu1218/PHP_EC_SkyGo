...
/**
 * Class ReceivingReturnedState
 *
 */

require_once( dirname(__FILE__) . "/UnifiedReturnedState.php" );

class ReceivingReturnedState implements UnifiedReturnedState {
    ...
    public function canChangeState(UnifiedReturnedState $state) {
        return ($state instanceof CompletedReturnedState) || ($state instanceof CancelReturnedState);
    }
