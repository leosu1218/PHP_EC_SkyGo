...
require_once( dirname(__FILE__) . "/PaidOrderState.php" );

class PreparedOrderState implements UnifiedOrderState {
    ...
    public function canChangeState(UnifiedOrderState $state) {
        return (($state instanceof PaidOrderState) ||
                ($state instanceof AbnormalOrderState)||
