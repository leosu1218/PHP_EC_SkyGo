...
/**
 * Class DeliveryAllGroupBuyingState
 *
 */
...
class DeliveryAllGroupBuyingState extends GroupBuyingActivityState {
    ...
    public function canChangeState(GroupBuyingActivityState $state) {
        return ($state instanceof DeliveryCompletedGroupBuyingState);
    }
    ...
    public function setDbCondition(DbHero &$dao, &$conditions, &$params, $tableAlias) {
        ...
        array_push($conditions, "$tableAlias.buyer_counter=delivery_order.counter");
