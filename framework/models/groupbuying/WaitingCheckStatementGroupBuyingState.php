...
/**
 * Class WaitingCheckStatementGroupBuyingState
 *
 */

require_once( dirname(__FILE__) . "/GroupBuyingActivityState.php" );

class WaitingCheckStatementGroupBuyingState extends GroupBuyingActivityState {
    ...
    public function getChangeAttributes() {
        return array(
            ...
            "request_statement_date" => date("Y-m-d H:i:s")
        );
    }
    ...
    public function canChangeState(GroupBuyingActivityState $state) {
        return ( ($state instanceof AbnormalStatementGroupBuyingState) ||
            ($state instanceof ConfirmedStatementGroupBuyingState));
    }
